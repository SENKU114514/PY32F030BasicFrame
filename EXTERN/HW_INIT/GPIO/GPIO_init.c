...
#if defined(PY32F002BPRE)
    [A0] = {GPIOA, LL_GPIO_PIN_0},
    [A1] = {GPIOA, LL_GPIO_PIN_1},
    [A2] = {GPIOA, LL_GPIO_PIN_2},
    [A3] = {GPIOA, LL_GPIO_PIN_3},
    [A4] = {GPIOA, LL_GPIO_PIN_4},
    [A5] = {GPIOA, LL_GPIO_PIN_5},
    [A6] = {GPIOA, LL_GPIO_PIN_6},
    [A7] = {GPIOA, LL_GPIO_PIN_7},
    [B0] = {GPIOB, LL_GPIO_PIN_0},
    [B1] = {GPIOB, LL_GPIO_PIN_1},
    [B2] = {GPIOB, LL_GPIO_PIN_2},
    [B3] = {GPIOB, LL_GPIO_PIN_3},
    [B4] = {GPIOB, LL_GPIO_PIN_4},
    [B5] = {GPIOB, LL_GPIO_PIN_5},
    [B6] = {GPIOB, LL_GPIO_PIN_6},
    [B7] = {GPIOB, LL_GPIO_PIN_7},
    [C0] = {GPIOC, LL_GPIO_PIN_0},
    [C1] = {GPIOC, LL_GPIO_PIN_1},
#elif defined(PY32F030PRE)
	#ifdef GPIOA
    GPIO_MAP_PORT(A),
#endif
...
#endif
#if defined(PY32F002BPRE)
    GPIO_EXTI_MAP(C0, LL_EXTI_CONFIG_PORTC, LL_EXTI_CONFIG_LINE0, LL_EXTI_LINE_0, 0U, EXTI0_1_IRQn),
    GPIO_EXTI_MAP(C1, LL_EXTI_CONFIG_PORTC, LL_EXTI_CONFIG_LINE1, LL_EXTI_LINE_1, 1U, EXTI0_1_IRQn),
#endif
};
